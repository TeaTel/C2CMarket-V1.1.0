...
.nav-create { padding: 6px 14px; border-radius: 16px; border: none; background: linear-gradient(135deg, #FF6A00, #FF8533); color: #fff; font-size: 13px; font-weight: 600; cursor: pointer; }
...
.create-btn { margin-top: 20px; padding: 12px 40px; border-radius: 20px; border: none; background: linear-gradient(135deg, #FF6A00, #FF8533); color: #fff; font-size: 15px; font-weight: 600; cursor: pointer; display: block; margin: 20px auto 10px; }
