<template>
  <div class="ad-edit-page">
    ...
    <div class="form-area">
      ...
      <textarea v-model="content" class="content-input" placeholder="描述你的广告内容..." maxlength="10000"></textarea>
...
.package-card.active {
  border-color: #ff6a00; background: #fff8f2;
...
.package-badge.standard { background: linear-gradient(135deg, #FF6A00, #FF8533); }
...
.price-symbol { font-size: 14px; color: #ff6a00; font-weight: 600; }
.price-value { font-size: 24px; color: #ff6a00; font-weight: 700; }
...
.detail-value.highlight { color: #ff6a00; font-weight: 700; }
...
.package-check {
  ...
  background: #ff6a00; border-radius: 50%; display: flex;
...
.pay-amount { font-size: 22px; font-weight: 700; color: #ff6a00; }
.pay-modal-notice {
