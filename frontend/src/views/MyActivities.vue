...
async function handleCreate() {
  ...
  try {
    ...
    if (res.code === 200) {
      ...
      form.value = { title: '', content: '', location: '', startTime: '', endTime: '', contact: '' }
      errors.value = {}
...
.form-input:focus { border-color: #FF6A00; background: #fff; }
...
.form-textarea:focus { border-color: #FF6A00; background: #fff; }
...
.spinner {
  width: 32px; height: 32px; border: 3px solid #E8ECF0; border-top-color: #FF6A00;
...
.status-upcoming { background: linear-gradient(135deg, #FF6A00, #FF8533); }
