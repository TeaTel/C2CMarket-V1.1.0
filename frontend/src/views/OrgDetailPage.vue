  ...
  <div class="org-detail-page">
    ...
    <main v-else-if="org" class="org-content">
      <section class="org-header">
        <div class="org-logo" :style="{ backgroundColor: '#FF6A00' }">{{ org.name.charAt(0) }}</div>
        <h1>{{ org.name }}</h1>
...
.panel-tabs button.active { color: #FF6A00; font-weight: 600; border-bottom: 2px solid #FF6A00; }
...
.btn-primary { padding: 10px 20px; border: none; border-radius: 8px; background: linear-gradient(135deg,#FF6A00,#FF8533); color: #fff; font-size: 14px; font-weight: 600; cursor: pointer; }
