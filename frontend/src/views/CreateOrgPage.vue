...
.step-dot.active .step-num { background: linear-gradient(135deg, #FF6A00, #FF8533); color: #fff; }
...
.type-btn.selected { border-color: #FF6A00; background: #FFF7E6; color: #FF6A00; }
...
.join-opt input { accent-color: #FF6A00; }
...
.btn-primary { padding: 12px 48px; border-radius: 24px; border: none; background: linear-gradient(135deg, #FF6A00, #FF8533); color: #fff; font-size: 15px; font-weight: 600; cursor: pointer; }
